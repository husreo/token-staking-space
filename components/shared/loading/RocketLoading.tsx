  ...
  return (
    <div
      ...
      className={classNames(
        "absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 transform items-center justify-center overflow-hidden rounded-full border border-transparent bg-[center_center] bg-no-repeat text-center shadow-[0px_0px_24px_4px_rgba(#2a3d38,0.2)]",
        className,
      )}
    >
      <RocketIcon className="w-5" />
      <div
        style={{
          backgroundImage:
