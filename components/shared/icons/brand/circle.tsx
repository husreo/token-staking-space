...
const CircleLogo = ({ className = "" }: { className?: string }) => (
  ...
  >
    <defs>
      ...
      <style>{".cls-3{fill:inherit}"}</style>
    </defs>
    <path
      d="m319.43 110.37-5-8.78a5.14 5.14 0 0 0-8.11-1.08L294.82 112a5.17 5.17 0 0 0-.64 6.51 90.22 90.22 0 0 1 10 20.58 90.2 90.2 0 0 1-85.45 119 89.38 89.38 0 0 1-42.26-10.49l19.45-19.46a64.41 64.41 0 0 0 80.77-88.29 5.15 5.15 0 0 0-8.29-1.41L256.76 150a5.14 5.14 0 0 0-1.37 4.82l1 4.18a38.63 38.63 0 0 1-56.75 42.39l-5.13-2.94a5.13 5.13 0 0 0-6.2.83l-47.51 47.5a5.15 5.15 0 0 0 .51 7.73l7 5.37a114.86 114.86 0 0 0 70.46 23.88 116 116 0 0 0 100.66-173.39Z"
      style={{
        fill: "url(#linear-gradient)",
      }}
    />
    <path
      d="M289.21 75.82a114.83 114.83 0 0 0-70.46-23.89 116 116 0 0 0-100.69 173.44l5 8.77a5.16 5.16 0 0 0 8.12 1.09l11.48-11.48a5.19 5.19 0 0 0 .64-6.5 89.81 89.81 0 0 1-10-20.58 90.2 90.2 0 0 1 85.45-119A89.29 89.29 0 0 1 261 88.19l-19.46 19.45a64.39 64.39 0 0 0-87.21 60.23c0 1.07.29 5.95.38 6.79a64.76 64.76 0 0 0 6.07 21.27 5.16 5.16 0 0 0 8.3 1.41l11.64-11.65a5.15 5.15 0 0 0 1.38-4.81l-1-4.19a38.62 38.62 0 0 1 56.75-42.38l5.13 2.94a5.16 5.16 0 0 0 6.2-.83l47.5-47.5a5.16 5.16 0 0 0-.5-7.74Z"
      style={{
    ...
    >
      ...
      />
      <path
        d="M539.21 105.54h-11.39a5 5 0 0 0-4.83 4.85v115a5 5 0 0 0 4.83 4.86h11.39a5 5 0 0 0 4.83-4.86v-115a5 5 0 0 0-4.83-4.85Z"
        className="cls-3"
      ...
      />
      <path
        d="M901.35 210.94h-45.2V110.39a5 5 0 0 0-4.83-4.85h-11.39a4.85 4.85 0 0 0-4.83 4.85v115a4.85 4.85 0 0 0 4.83 4.86h61.42a4.85 4.85 0 0 0 4.84-4.86v-9.55a4.85 4.85 0 0 0-4.84-4.9Z"
        className="cls-3"
      ...
      />
      <path
        d="M1003.67 125a4.85 4.85 0 0 0 4.83-4.85v-9.73a4.85 4.85 0 0 0-4.83-4.85h-69a4.85 4.85 0 0 0-4.83 4.85v115a4.85 4.85 0 0 0 4.83 4.86h69a4.85 4.85 0 0 0 4.83-4.86v-9.55a4.85 4.85 0 0 0-4.83-4.85h-53v-34.31h44.51a4.85 4.85 0 0 0 4.84-4.85v-9.72a5 5 0 0 0-4.84-4.86H950.7V125Z"
        className="cls-3"
