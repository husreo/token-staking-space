...
const ErrorToast: React.FC<Props> = ({ closeToast, message }) => {
  return (
    <div className="relative flex h-full w-[700px] items-center rounded-xl bg-gray2">
      <div className="z-10 flex items-center justify-between gap-10 px-6 py-1">
        ...
        <button
          onClick={() => closeToast()}
          className="flex h-8 w-8 basis-8 items-center justify-center rounded-[53px] bg-white/10"
        >
      ...
      >
        ...
        <g filter="url(#filter1_f_77_267)">
          <circle cx="29.5" cy="-3.5" r="41.5" fill="red"></circle>
        </g>
        <defs>
          <filter
            id="filter0_f_77_267"
